...
Command: npx gltfjsx@6.2.15 public/models/volcano_island_lowpoly.glb 
...
export function Volcano({
  ...
  const { nodes, materials } = useGLTF("/models/volcano_island_lowpoly.glb");
    ...
    if (!isRotating) {
      ...
      switch (true) {
        case normalizedRotation >= 5.45 && normalizedRotation <= 5.85:
          setCurrentStage(2);
          break;
        case normalizedRotation >= 0.25 && normalizedRotation <= 0.55:
          setCurrentStage(1);
          break;
...
useGLTF.preload("/models/volcano_island_lowpoly.glb");
